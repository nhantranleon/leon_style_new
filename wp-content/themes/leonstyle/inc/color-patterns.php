 ...
 */
function leonstyle_custom_colors_css() {
	 ...
	 */
	$saturation = apply_filters( 'leonstyle_custom_colors_saturation', 100 );
	 ...
	 */
	$saturation_selection = absint( apply_filters( 'leonstyle_custom_colors_saturation_selection', 50 ) );
	 ...
	 */
	$lightness = apply_filters( 'leonstyle_custom_colors_lightness', 33 );
	 ...
	 */
	$lightness_hover = apply_filters( 'leonstyle_custom_colors_lightness_hover', 23 );
	 ...
	 */
	$lightness_selection = apply_filters( 'leonstyle_custom_colors_lightness_selection', 90 );
	 ...
	 */
	return apply_filters( 'leonstyle_custom_colors_css', $theme_css, $primary_color, $saturation );
}
